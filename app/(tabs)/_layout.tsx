...
const items = [
  ...
  { route: 'profile', icon: 'map-outline', activeIcon: 'map' },
] as const;
...
export default function TabLayout() {
  return (
    <Tabs screenOptions={{ headerShown: false, tabBarStyle: styles.tabBar }} tabBar={(props) => <FloatingTabBar {...props} />}>
      ...
      <Tabs.Screen name="profile" options={{ title: 'Map' }} />
    </Tabs>
  );
}
...
const styles = StyleSheet.create({
  ...
  pill: { height: 78, borderRadius: 40, backgroundColor: '#3A3939', borderWidth: 1, borderColor: '#6A6867', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around', paddingHorizontal: 13, shadowColor: '#000', shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.38, shadowRadius: 12, elevation: 12 },
  iconButton: { width: 49, height: 60, alignItems: 'center', justifyContent: 'center' },
  activeIcon: { width: 49, height: 49, borderRadius: 25, backgroundColor: '#F9F9F9', alignItems: 'center', justifyContent: 'center', shadowColor: '#FFF', shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0.65, shadowRadius: 14, elevation: 7 },
